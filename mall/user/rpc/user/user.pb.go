...
var file_user_proto_rawDesc = []byte{
	...
	0x5c, 0x0a, 0x0c, 0x55, 0x73, 0x65, 0x72, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12,
	...
	0x67, 0x65, 0x18, 0x05, 0x20, 0x01, 0x28, 0x03, 0x52, 0x03, 0x61, 0x67, 0x65, 0x22, 0x09, 0x0a,
	0x07, 0x73, 0x61, 0x76, 0x65, 0x52, 0x65, 0x71, 0x22, 0x30, 0x0a, 0x08, 0x73, 0x61, 0x76, 0x65,
	0x52, 0x65, 0x73, 0x70, 0x12, 0x12, 0x0a, 0x04, 0x63, 0x6f, 0x64, 0x65, 0x18, 0x01, 0x20, 0x01,
	0x28, 0x03, 0x52, 0x04, 0x63, 0x6f, 0x64, 0x65, 0x12, 0x10, 0x0a, 0x03, 0x6d, 0x73, 0x67, 0x18,
	0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x6d, 0x73, 0x67, 0x32, 0x61, 0x0a, 0x04, 0x55, 0x73,
	...
	0x73, 0x65, 0x12, 0x29, 0x0a, 0x08, 0x73, 0x61, 0x76, 0x65, 0x55, 0x73, 0x65, 0x72, 0x12, 0x0d,
	0x2e, 0x75, 0x73, 0x65, 0x72, 0x2e, 0x73, 0x61, 0x76, 0x65, 0x52, 0x65, 0x71, 0x1a, 0x0e, 0x2e,
	0x75, 0x73, 0x65, 0x72, 0x2e, 0x73, 0x61, 0x76, 0x65, 0x52, 0x65, 0x73, 0x70, 0x62, 0x06, 0x70,
...
var file_user_proto_goTypes = []interface{}{
	...
	(*SaveReq)(nil),      // 2: user.saveReq
	(*SaveResp)(nil),     // 3: user.saveResp
}
var file_user_proto_depIdxs = []int32{
	0, // 0: user.User.getUser:input_type -> user.IdRequest
	2, // 1: user.User.saveUser:input_type -> user.saveReq
	1, // 2: user.User.getUser:output_type -> user.UserResponse
	3, // 3: user.User.saveUser:output_type -> user.saveResp
...
func (c *userClient) SaveUser(ctx context.Context, in *SaveReq, opts ...grpc.CallOption) (*SaveResp, error) {
	out := new(SaveResp)
...
type UserServer interface {
	...
	SaveUser(context.Context, *SaveReq) (*SaveResp, error)
}
...
func (*UnimplementedUserServer) SaveUser(context.Context, *SaveReq) (*SaveResp, error) {
...
func _User_SaveUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServer).SaveUser(ctx, req.(*SaveReq))
	}
	return interceptor(ctx, in, info, handler)
}
